...
<head>
    ...
    <title>Customer - CarroEdeg Laundry</title>
...
<style>
    body {
        background: linear-gradient(135deg, #eaf4ea, #f1f8e9);
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="functions/add-customer.php" method="post">
                        <div class="row">
                            <div class="col">
                                <div class="mb-3"><label class="form-label" for="first_name"><strong>First Name</strong></label><input class="form-control" type="text" placeholder="" name="firstname" required=""></div>
                            </div>
                            <div class="col">
                                <div class="mb-3"><label class="form-label" for="last_name"><strong>Last Name</strong></label><input class="form-control" type="text" placeholder="" name="lastname" required=""></div>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="functions/update-customer.php" method="post">
                        ...
                        <div class="mb-3"><label class="form-label" for="first_name"><strong>Address</strong></label><input class="form-control" type="text" placeholder="Address" name="address" required=""></div>
                        <div class="mb-3"><label class="form-label" for="first_name"><strong>Contact</strong>&nbsp;No.</label><input class="form-control" type="text" placeholder="Contact No." name="contact" minlength="10" maxlength="10"></div>
