...
<body class="mx-5" onload="<?php if (!isset($_GET['type'])){echo 'printPageAndRedirect()';}?>">
    ...
    <div class="table-responsive">
        ...
        <table class="table table-borderless">
                <thead class="font-monospace">
                    <tr class="font-monospace">
                        <th class="font-monospace text-center"><strong class="text-danger">**** FADLAN KEEN RECIEPT-GA SI AAD U QADATO DOOBIGAAGA ****</strong></th>
                    </tr>
                </thead>
                <tbody>
                    <tr></tr>
            ...
            <thead>
                <tr>
                    <th class="font-monospace text-center" style="color: var(--bs-gray-900);font-size: 13px;">
                        ...
                        <h1 class="display-1">CARROEDEG QRCODE</h1>
                    </th>
                </tr>
            </thead>
            <tbody>
