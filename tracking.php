...
<head>
    ...
    <title>CarroEdeg Laundry Tracking</title>
                    ...
                    <div class="card text-black card-stepper" style="border-radius:16px;">
                        <div class="card-body p-5">
                            <div class="row">
                                ...
                                <div class="col">
                                    <div class="text-end">
                                        <p class="mb-0">CarroEdeg Laundry</p>
                                    </div>
                                </div>
                            </div>
                            <?php
                            ...
                            ?>
                                ...
                                <div class="progress mx-0 mt-0 mb-5">
                                    <div class="progress-bar progress-bar-animated" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo $status ?>%;"></div>
                                </div>
                                <div class="row row-cols-6 row-cols-md-6 row-cols-xl-6 d-xl-flex justify-content-around gutter-y">
                                    <div class="col">
                                        <div class="d-lg-flex align-items-center"><i class="fas fa-clipboard-list fa-2x me-lg-4 mb-3 <?php if ($status >= 20) echo 'text-success'; ?>" title="Pending | <?=$date0??=''?>"></i>
                                    ...
                                    <div class="col">
                                        <div class="d-lg-flex align-items-center"><i class="fas fa-tshirt fa-2x me-lg-4 mb-3 <?php if ($status >= 30) echo 'text-success'; ?>" title="Washing | <?=$date1??=''?>"></i>
                                            <div class="d-none d-lg-block">
                                    ...
                                    <div class="col">
                                        <div class="d-lg-flex align-items-center"><i class="fas fa-box-open fa-2x me-lg-4 mb-3 <?php if ($status >= 50) echo 'text-success'; ?>" title="Folding | <?=$date2??=''?>"></i>
                                            <div class="d-none d-lg-block">
                                    ...
                                    <div class="col">
                                        <div class="d-lg-flex align-items-center"><i class="fas fa-box fa-2x me-lg-4 mb-3 <?php if ($status >= 80) echo 'text-success'; ?>" title="Ready for Pickup | <?=$date3??=''?>"></i>
                                            <div class="d-none d-lg-block">
                                    ...
                                    <div class="col">
                                        <div class="d-lg-flex align-items-center"><i class="fas fa-check fa-2x me-lg-4 mb-3 <?php if ($status >= 100) echo 'text-success'; ?>" title="Order Claimed | <?=$date4??=''?>"></i>
                                            <div class="d-none d-lg-block">
