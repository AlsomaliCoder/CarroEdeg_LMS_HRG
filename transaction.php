...
// Fetch total price
$sql = "SELECT l.kilo, p.price FROM laundry AS l 
        JOIN transactions AS t ON l.transaction_id = t.id 
        JOIN prices AS p ON l.type = p.id 
        WHERE t.user_id = :user_id AND t.status = 'pending'";
$stmt = $db->prepare($sql);
...
<head>
    ...
    <title>Transaction - CarroEdeg Laundry</title>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="functions/add-product.php" method="post">
                    ...
                    <!-- Select Item Dropdown (Optional) -->
                    <div class="mb-3">
                        <label class="form-label" for="item"><strong>Item (Optional)</strong></label>
                    ...
                    <!-- Manual Entry Field -->
                    <div class="mb-3">
                        <label class="form-label"><strong>Or Enter Item Name</strong></label>
                        <input class="form-control" type="text" name="custom_item" placeholder="Enter item name">
                    </div>

                    <!-- Quantity -->
                    <div class="mb-3">
                        <label class="form-label"><strong>Quantity</strong></label>
                        <input class="form-control" type="number" name="qty" pattern="\d+" placeholder="Qty" min="1" value="1">
                    </div>
                        ...
                        <button class="btn btn-primary" type="submit">Add</button>
                            ...
                            <!-- my code  -->
                                <div class="card shadow <?php if ($fullname == 'NONE') {echo 'd-none';}?>">
                                    <div class="card-header py-3">
                                        <p class="text-primary m-0 fw-bold">alaabaha</p>
                                    </div>
                                    <div class="card-body">
