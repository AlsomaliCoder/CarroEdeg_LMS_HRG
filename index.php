...
<head>
    ...
    <title>Dashboard - CarroEdeg Laundry</title>
...
<link rel="stylesheet" href="assets/css/dataTables.bootstrap5.min.css">
    ...
    .btn-primary, .border-start-primary {
        background-color: #4CAF50 !important;
        border-color: #4CAF50 !important;
    }

    .border-start-success {
        border-left: .25rem solid #81c784 !important;
    }

    .border-start-info {
        border-left: .25rem solid #64b5f6 !important;
    }

    .border-start-warning {
        border-left: .25rem solid #ffb74d !important;
    }
...
<body id="page-top">
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion p-0 toggled" style="background:#2626EB;">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="index.php">
                    ...
                    <div class="sidebar-brand-text mx-3"><span>Carro Edeg<br>Laundry<br></span></div>
                </a>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                <nav class="navbar navbar-light navbar-expand bg-white shadow mb-4 topbar static-top bg-gray-900">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-primary py-2 bg-dark p-20">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-primary fw-bold text-xs mb-1"><span>icome  (monthly) - <?php echo date('F')?> </span></div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-success py-2 bg-danger-subtle bs-primary bg-primary">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                                            <div class="text-uppercase text-success fw-bold text-xs mb-1"><span>icome yearyly (annual) - <?php echo date('Y')?> </span></div>
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-info py-2 bg-primary">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
                        ...
                        <div class="col-md-6 col-xl-3 mb-4">
                            <div class="card shadow border-start-warning py-2 bg-info">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        <div class="col me-2">
